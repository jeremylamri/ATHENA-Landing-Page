...
export const About: React.FC = () => {
  ...
  return (
    <section id="about" className="py-16 md:py-24 border-t border-white/5 scroll-mt-24 md:scroll-mt-32 print:bg-white print:text-black print:border-none">
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-4 md:space-y-6">
            <GlassCard className="flex items-start gap-4 print:bg-slate-50 print:border-slate-200 print:shadow-none">
              <div className="bg-accent/10 p-3 rounded-lg text-accent shrink-0 print:bg-slate-200 print:text-accent-700">
                <Globe size={24} />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-white mb-2 print:text-black">{t('about.cards.sovereignty.title')}</h3>
            ...
            <GlassCard className="flex items-start gap-4 print:bg-slate-50 print:border-slate-200 print:shadow-none">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2 print:text-black">{t('about.cards.leadership.title')}</h3>
                <p className="text-sm text-white/60 leading-relaxed print:text-slate-600">
            ...
            <GlassCard className="flex items-start gap-4 print:bg-slate-50 print:border-slate-200 print:shadow-none">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white mb-2 print:text-black">{t('about.cards.innovation.title')}</h3>
                <p className="text-sm text-white/60 leading-relaxed print:text-slate-600">
