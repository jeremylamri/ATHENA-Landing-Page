        ...
        <div className="relative z-10 order-1 lg:order-1">
          ...
          >
            ...
            <h1 className="text-3xl sm:text-4xl md:text-6xl font-semibold tracking-tight leading-[1.1] mb-6 text-white">
              Professionnalisez l'ingénierie des compétences avec ATHENA
            </h1>
            <p className="text-base md:text-lg text-white/70 leading-relaxed mb-8 max-w-2xl">
              <strong className="text-white font-medium block mb-2">L'initiative qui redéfinit les standards de l'ingénierie de formation pour la décennie à venir.</strong>
              ATHENA dote les directions L&D d'un outil d'une puissance inédite pour redéfinir les standards de la formation, et augmenter l'ingénierie pédagogique par la science et la technologie.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="secondary" onClick={() => window.open('?view=one-pager', '_blank')} className="w-full sm:w-auto">
